...
nf-test asserting on a warning finds nothing — while `error()` _is_ reported there, which makes the
...
This matters wherever a warning is the _specified behaviour_ rather than noise — in this pipeline a
